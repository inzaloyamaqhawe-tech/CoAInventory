...
export const NAV = [
  { path: '/', label: 'Dashboard', icon: 'home', roles: ['ops_manager', 'owner', 'stock_controller', 'branch_manager', 'administrator', 'sales_associate'] },
  { path: '/stock', label: 'Stock', icon: 'layers', roles: ['ops_manager', 'owner', 'stock_controller', 'branch_manager', 'administrator', 'sales_associate'] },
  ...
  { path: '/branches', label: 'Branches', icon: 'store', roles: ['ops_manager', 'owner', 'stock_controller'] },
  { path: '/alerts', label: 'Alerts', icon: 'bell', roles: ['ops_manager', 'owner', 'stock_controller', 'branch_manager', 'administrator'] },
  { path: '/reports', label: 'Reports', icon: 'chart', roles: ['ops_manager', 'owner', 'stock_controller', 'branch_manager'] },
